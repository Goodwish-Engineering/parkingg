...
class VehicleMembershipScreen extends StatefulWidget {
  final RegistrationData data;
  final VoidCallback onNext;
  final VoidCallback onPrevious;

  const VehicleMembershipScreen({
    super.key,
    required this.data,
  ...
  @override
  State<VehicleMembershipScreen> createState() =>
      _VehicleMembershipScreenState();
}

class _VehicleMembershipScreenState extends State<VehicleMembershipScreen> {
